<x-app-layout>
    ...
    <div x-data>
        <button x-on:click="$dispatch('modal2', { openModal: 'true',titulo: 'tITULO', mensaje: 'mENSAJE' })">
            Click
        </button>
    </div>
...
<div x-data='{openModal:false, titulo:"", mensaje:""}' x-show='openModal'
    ...
    aria-modal="true">
    <template x-on:modal2.window="openModal = $event.detail.openModal; titulo = $event.detail.titulo;mensaje = $event.detail.mensaje;"></template>
    <div
